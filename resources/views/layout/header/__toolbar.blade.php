        ...
        <div class="d-flex align-items-stretch overflow-auto pt-3 pt-lg-0">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="d-flex align-items-center ps-4" id="kt_toolbar">
                    ...
                    <span id="kt_toolbar_slider_value" class="d-flex flex-center bg-light-primary rounded-circle w-35px h-35px ms-4 fs-7 fw-bold text-primary"
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="d-flex">
                    ...
                    <div class="d-flex align-items-center">
                        <!--begin::Menu- wrapper-->
                        <a href="?page=apps/subscriptions/add" class="btn btn-sm btn-icon btn-icon-muted btn-active-icon-primary">
                            <i class="ki-duotone ki-add-files fs-1"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i>                        </a>
                        <!--end::Menu wrapper-->
                    </div>
                    <!--end::Notifications-->
                    <!--begin::Quick links-->
                    <div class="d-flex align-items-center">
                        <!--begin::Menu wrapper-->
                        <a href="?page=apps/file-manager/folders" class="btn btn-sm btn-icon btn-icon-muted btn-active-icon-primary">
                            <i class="ki-duotone ki-file-up fs-1"><span class="path1"></span><span class="path2"></span></i>
                        </a>
                        <!--end::Menu wrapper-->
                    </div>
                    <!--end::Quick links-->
